...
#line 107 "http11/c/http11.c"
	...
	goto st0;
tr2:
#line 27 "http11/c/http11.rl"
	{
        printf("%.*s", p - data - parser->mark, data + parser->mark);
    }
	goto st3;
st3:
	if ( ++p == pe )
