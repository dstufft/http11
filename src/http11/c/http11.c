...
#line 400 "src/http11/c/http11.rl"




#line 136 "src/http11/c/http11.c"
...
#line 404 "src/http11/c/http11.rl"
...
#line 443 "src/http11/c/http11.rl"
    
#line 186 "src/http11/c/http11.c"
	{
	 parser->state->cs = http_parser_start;
	}

#line 444 "src/http11/c/http11.rl"
...
#line 530 "src/http11/c/http11.rl"
    
#line 280 "src/http11/c/http11.c"
	{
	if ( p == pe )
		goto _test_eof;
	goto _resume;
...
case 1:
	...
	goto st0;
tr20:
#line 347 "src/http11/c/http11.rl"
	{
        parser->error = EBADVERSION;
    }
	goto st0;
#line 379 "src/http11/c/http11.c"
st0:
 parser->state->cs = 0;
	goto _out;
tr0:
#line 130 "src/http11/c/http11.rl"
	{
...
st2:
	if ( ++p == pe )
		goto _test_eof2;
case 2:
#line 393 "src/http11/c/http11.c"
	switch( (*p) ) {
		case 10: goto st2;
		case 13: goto st3;
		case 33: goto tr7;
...
st3:
	if ( ++p == pe )
		goto _test_eof3;
case 3:
#line 429 "src/http11/c/http11.c"
	if ( (*p) == 10 )
		goto st2;
	goto st0;
tr3:
...
#line 134 "src/http11/c/http11.rl"
	{
...
st4:
	if ( ++p == pe )
		goto _test_eof4;
case 4:
#line 453 "src/http11/c/http11.c"
	switch( (*p) ) {
		case 9: goto tr8;
		case 32: goto tr8;
		case 33: goto st4;
	...
	goto st0;
tr8:
#line 138 "src/http11/c/http11.rl"
	{
...
st5:
	if ( ++p == pe )
		goto _test_eof5;
case 5:
#line 496 "src/http11/c/http11.c"
	switch( (*p) ) {
		case 10: goto st0;
		case 32: goto st5;
	}
	...
	goto tr10;
tr10:
#line 146 "src/http11/c/http11.rl"
	{
...
st6:
	if ( ++p == pe )
		goto _test_eof6;
case 6:
#line 514 "src/http11/c/http11.c"
	switch( (*p) ) {
		case 10: goto st0;
		case 32: goto tr13;
	}
	...
	goto st6;
tr13:
#line 150 "src/http11/c/http11.rl"
	{
...
st7:
	if ( ++p == pe )
		goto _test_eof7;
case 7:
#line 536 "src/http11/c/http11.c"
	switch( (*p) ) {
		case 10: goto st0;
		case 32: goto st7;
		case 72: goto tr15;
	...
	goto st6;
tr15:
#line 158 "src/http11/c/http11.rl"
	{
...
st8:
	if ( ++p == pe )
		goto _test_eof8;
case 8:
#line 555 "src/http11/c/http11.c"
	if ( (*p) == 84 )
		goto st9;
	goto st0;
st9:
...
case 15:
	...
	goto st0;
tr24:
#line 162 "src/http11/c/http11.rl"
	{
...
st16:
	if ( ++p == pe )
		goto _test_eof16;
case 16:
#line 624 "src/http11/c/http11.c"
	switch( (*p) ) {
		case 10: goto tr26;
		case 13: goto tr27;
		case 33: goto tr28;
	...
	goto st0;
tr26:
#line 218 "src/http11/c/http11.rl"
	{
...
#line 351 "src/http11/c/http11.rl"
	{
...
#line 351 "src/http11/c/http11.rl"
	...
	goto st46;
tr46:
#line 298 "src/http11/c/http11.rl"
	{
...
#line 351 "src/http11/c/http11.rl"
	...
	goto st46;
tr74:
#line 256 "src/http11/c/http11.rl"
	{
...
st46:
	if ( ++p == pe )
		goto _test_eof46;
case 46:
#line 807 "src/http11/c/http11.c"
	goto st0;
tr27:
#line 218 "src/http11/c/http11.rl"
	{
...
st17:
	if ( ++p == pe )
		goto _test_eof17;
case 17:
#line 948 "src/http11/c/http11.c"
	if ( (*p) == 10 )
		goto tr29;
	goto st0;
tr28:
...
#line 194 "src/http11/c/http11.rl"
	{
...
st18:
	if ( ++p == pe )
		goto _test_eof18;
case 18:
#line 1115 "src/http11/c/http11.c"
	switch( (*p) ) {
		case 33: goto st18;
		case 58: goto tr31;
		case 124: goto st18;
	...
	goto st0;
tr31:
#line 198 "src/http11/c/http11.rl"
	{
	...
	goto st19;
tr33:
#line 206 "src/http11/c/http11.rl"
	{
        parser->state->field_value = MARK_START(p, buf, parser->state->mark);
    }
#line 210 "src/http11/c/http11.rl"
	{
...
st19:
	if ( ++p == pe )
		goto _test_eof19;
case 19:
#line 1168 "src/http11/c/http11.c"
	switch( (*p) ) {
		case 9: goto tr33;
		case 10: goto tr34;
		case 13: goto tr35;
...
st20:
	if ( ++p == pe )
		goto _test_eof20;
case 20:
#line 1189 "src/http11/c/http11.c"
	switch( (*p) ) {
		case 9: goto tr37;
		case 10: goto tr38;
		case 13: goto tr39;
...
st21:
	if ( ++p == pe )
		goto _test_eof21;
case 21:
#line 1214 "src/http11/c/http11.c"
	switch( (*p) ) {
		case 9: goto st21;
		case 10: goto st24;
		case 13: goto st25;
...
st23:
	if ( ++p == pe )
		goto _test_eof23;
case 23:
#line 1253 "src/http11/c/http11.c"
	switch( (*p) ) {
		case 9: goto st23;
		case 10: goto st24;
		case 13: goto st25;
...
st26:
	if ( ++p == pe )
		goto _test_eof26;
case 26:
#line 1325 "src/http11/c/http11.c"
	switch( (*p) ) {
		case 9: goto st27;
		case 10: goto tr46;
		case 13: goto tr47;
...
st27:
	if ( ++p == pe )
		goto _test_eof27;
case 27:
#line 1367 "src/http11/c/http11.c"
	switch( (*p) ) {
		case 9: goto tr50;
		case 10: goto tr38;
		case 13: goto tr39;
...
st28:
	if ( ++p == pe )
		goto _test_eof28;
case 28:
#line 1406 "src/http11/c/http11.c"
	if ( (*p) == 10 )
		goto st26;
	goto st0;
tr25:
...
st29:
	if ( ++p == pe )
		goto _test_eof29;
case 29:
#line 1424 "src/http11/c/http11.c"
	if ( (*p) == 10 )
		goto st16;
	goto st0;
tr4:
...
st30:
	if ( ++p == pe )
		goto _test_eof30;
case 30:
#line 1446 "src/http11/c/http11.c"
	switch( (*p) ) {
		case 9: goto tr8;
		case 32: goto tr8;
		case 33: goto st4;
...
st38:
	if ( ++p == pe )
		goto _test_eof38;
case 38:
#line 1618 "src/http11/c/http11.c"
	switch( (*p) ) {
		case 9: goto st38;
		case 32: goto st38;
	}
	...
	goto st0;
tr62:
#line 170 "src/http11/c/http11.rl"
	{
...
st39:
	if ( ++p == pe )
		goto _test_eof39;
case 39:
#line 1639 "src/http11/c/http11.c"
	if ( 48 <= (*p) && (*p) <= 57 )
		goto st40;
	goto st0;
st40:
...
case 41:
	...
	goto st0;
tr65:
#line 174 "src/http11/c/http11.rl"
	{
...
st42:
	if ( ++p == pe )
		goto _test_eof42;
case 42:
#line 1676 "src/http11/c/http11.c"
	switch( (*p) ) {
		case 10: goto st44;
		case 32: goto st42;
		case 127: goto st0;
	...
	goto tr68;
tr68:
#line 182 "src/http11/c/http11.rl"
	{
...
st43:
	if ( ++p == pe )
		goto _test_eof43;
case 43:
#line 1701 "src/http11/c/http11.c"
	switch( (*p) ) {
		case 10: goto tr72;
		case 13: goto tr73;
		case 127: goto st0;
...
#line 174 "src/http11/c/http11.rl"
	...
	goto st44;
tr72:
#line 186 "src/http11/c/http11.rl"
	{
...
st44:
	if ( ++p == pe )
		goto _test_eof44;
case 44:
#line 1737 "src/http11/c/http11.c"
	switch( (*p) ) {
		case 10: goto tr74;
		case 13: goto tr75;
		case 33: goto tr76;
...
st45:
	if ( ++p == pe )
		goto _test_eof45;
case 45:
#line 1787 "src/http11/c/http11.c"
	if ( (*p) == 10 )
		goto st44;
	goto st0;
	}
	...
	case 44: 
	case 45: 
#line 355 "src/http11/c/http11.rl"
	{
        parser->error = EEOF;
        { parser->state->cs = (http_parser_error); goto _again;}
    }
...
#line 355 "src/http11/c/http11.rl"
	...
	break;
#line 1904 "src/http11/c/http11.c"
	}
	}
...
#line 531 "src/http11/c/http11.rl"
